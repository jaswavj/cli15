...
<body>
    ...
    <div class="container mt-4">
        <h3 class="mb-4">Bike Inventory Sold Return Report</h3>

        <% if (setupError != null) { %>
        <div class="alert alert-danger">Unable to load filters: <%=setupError%></div>
        <% } %>

        <form action="<%=contextPath%>/inventory/SoldReturn/report/page0.jsp" method="get" class="row g-3">
            <div class="col-md-2">
